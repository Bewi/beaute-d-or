 ...
 */
add_action( 'init', 'beautedor_flex_grid_load_textdomain' );

function beautedor_flex_grid_load_textdomain() {
	load_plugin_textdomain( 'beautedor', false, basename( __DIR__ ) . '/languages' );
}

function beautedor_flex_grid_register_block() {
	$namespace = 'beautedor';
	$blockType = 'flex-grid';
...
add_action( 'init', 'beautedor_flex_grid_register_block' );
