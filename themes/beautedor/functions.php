...
/***************************************************************** */
/***************************************************************** */
function tribe_events_event_info( $event = null, $before = '', $after = '' ) {
	if ( is_null( $event ) ) {
		global $post;
		$event = $post;
	}
	...
	$inner = '<span class="event__info__date">';
	$inner .= tribe_get_start_date( $event, false, $date_with_year_format );
	$inner .= '</span>';
	$inner .= '<span class="event__info__time">';
	$inner .= tribe_get_start_date( $event, false, $time_format );
	$inner .= '</span>';
	$inner .= '<span class="event__info__price">' . (tribe_get_formatted_cost() ? tribe_get_cost( null, true ) : '0€') . '</span>';
